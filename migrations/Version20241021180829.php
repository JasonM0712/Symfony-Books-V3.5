 ...
 */
final class Version20241021180829 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaires_emprunts ADD CONSTRAINT FK_F7B9E104EBF07F38 FOREIGN KEY (livres_id) REFERENCES livres (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
